...
urlpatterns = [
    ...
    path('update/<int:pk>/', views.ProductsUpdateView.as_view(success_url=reverse_lazy('ads:all')), name='product_update'),
    path('delete/<int:pk>/', views.ProductsDeleteView.as_view(success_url=reverse_lazy('ads:all')), name='product_delete'),
